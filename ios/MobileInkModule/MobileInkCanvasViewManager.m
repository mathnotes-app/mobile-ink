...
RCT_EXPORT_VIEW_PROPERTY(renderScale, CGFloat)
RCT_EXPORT_VIEW_PROPERTY(renderViewportLeftRatio, CGFloat)
RCT_EXPORT_VIEW_PROPERTY(renderViewportTopRatio, CGFloat)
RCT_EXPORT_VIEW_PROPERTY(renderViewportWidthRatio, CGFloat)
RCT_EXPORT_VIEW_PROPERTY(renderViewportHeightRatio, CGFloat)
